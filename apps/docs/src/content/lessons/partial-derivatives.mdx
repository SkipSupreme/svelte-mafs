...
No new machinery. The power rule, the sum rule, the constant-multiple rule — all still apply. The only new habit is noticing which symbol is the variable you're currently paying attention to.
</Step>
