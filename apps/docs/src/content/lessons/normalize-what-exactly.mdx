...
**BN:** reduce over the batch dimension, normalize per feature. Default for vision and CNNs with stable, large batches. Fragile when the batch is small or non-i.i.d. — you've seen the size-1 disaster.
