...
summary: When a function returns multiple numbers, stack its gradients into a grid — that's the Jacobian. Compose two functions and their Jacobians multiply. Neural networks are exactly this, about a hundred times in a row.
estimatedMinutes: 20
order: 4
prereqs:
